...
def func_open() :
    global window, canvas, paper, photo, photo2, oriX, oriY
    readFp = askopenfilename(parent = window, filetypes = (("모든 그림 파일", "*.jpg; *.jpeg; *.png; *.tif; *.gif"), ("모든파일", "*.*")))
...
image2Menu.add_command(label = "발게", command =func_bright)
